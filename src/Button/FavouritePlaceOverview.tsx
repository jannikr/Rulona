...
type Props = ReturnType<typeof mapStateToProps> &
  ReturnType<typeof mapDispatchToProps> & { clickedPlace: Place };
...
const FavouritePlace: React.FC<Props> = (props) => {
  ...
  if (favouritePlaces.includes(clickedPlace)) {
    return (
      <>
        <IconButton
          onClick={(): void => {
            deleteFavouritePlace(clickedPlace);
          }}
        >
          <Bookmark />
        </IconButton>
    ...
    return (
      <>
        <IconButton
          onClick={(): void => {
            addFavouritePlace(clickedPlace);
          }}
        >
          <BookmarkBorder />
        </IconButton>
